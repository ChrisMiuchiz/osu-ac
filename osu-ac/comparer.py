...
class Comparer:
    ...
    def compare(self, mode):
        ...
        In both cases, prints the result of each comparison according to _print_results.
        ...
        for replay1, replay2 in iterator:
            ...
            self._print_result(result, replay1.player_name, replay2.player_name)
    ...
    def _print_result(self, result, player1, player2):
        """
        ...
        Args:
            ...
            String player1: The name to display for the first player.
            String player2: The name to display for the second player.
        """
